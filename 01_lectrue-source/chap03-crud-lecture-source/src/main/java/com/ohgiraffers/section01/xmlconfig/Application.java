...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   우리는 아직 view 즉 사용자들이 ㅣ정보를 입력할 수 있는 화면을 배우지 않았다.
        ...
        * */
        ...
        do {
            ...
            switch (no) {
                ...
                case 3 : menuController.registMenu(intputMenu()); break;
    ...
    private static Map<String, String> inputModifyMenu() {
        ...
        Map<String, String> parameter = new HashMap<>();        // map 컬렉션에 담아주기 . new hashmap 은 다형성
    ...
    private static Map<String, String> intputMenu() {
    ...
    private static Map<String, String> inputMenuCode() {
        ...
        Map<String, String> parameter = new HashMap<>();
        parameter.put("code", code);        // 키 값, 밸류 값
