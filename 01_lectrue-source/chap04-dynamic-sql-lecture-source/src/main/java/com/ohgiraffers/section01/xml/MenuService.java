...
public class MenuService {
    ...
    public void selectMenuByPrice(int price) {
        ...
        *       혹은 dto 의 getter 를 이용하여 값을 확인할 수 있다.
        * */
        Map<String, Integer> map = new HashMap<>();     // 기본자료형 int 를 상위자료형 Integer 로 오토박싱
        map.put("price", price);
    ...
    public void searchMenuByCodeOrSearchAll(SearchCriteria searchCriteria) {
        ...
        SqlSession sqlSesison = getSqlSession();
        mapper = sqlSesison.getMapper(DynamicSqlMapper.class);
    ...
    public void modifyMenu(Map<String, Object> criteria) {
        ...
        if(result > 0) {
            ...
            System.out.println("메뉴 정보 변경에 실패하셨습니다...ㅜ");
            sqlSession.rollback();
        }
